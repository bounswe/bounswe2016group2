...
public class ServerCommentPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_server_comment_page);
        listView = (ListView) findViewById(R.id.comm_list);
        lofc = (ArrayList<RestaurantComment>) getIntent().getExtras().getSerializable("comments");
        getUsrnameForComments();
    }

    private void getUsrnameForComments() {
        for (final RestaurantComment fc:lofc) {
        ...
        ServerCommentAdapter cmn = new ServerCommentAdapter(ServerCommentPageActivity.this,lofc2);
